...
r'''
python C:\Users\cwu\Desktop\Software\FreeFlux\tutorials\tutorial_toy_steady_state_estimation.py   # TODO delete
'''


MODEL_FILE = r'C:\Users\cwu\Desktop\Software\FreeFlux/models/toy/reactions.tsv'
MEASURED_MDVS = r'C:\Users\cwu\Desktop\Software\FreeFlux/models/toy/measured_MDVs.tsv'
MEASURED_FLUXES = r'C:\Users\cwu\Desktop\Software\FreeFlux/models/toy/measured_fluxes.tsv'
OUT_DIR = r'C:\Users\cwu\Desktop\Software\FreeFlux/results/toy/steady_state_estimation'
# TODO
...
def toy_model_steady_state():
    
    model = Model('demo_TCA')
...
def toy_model_steady_state_with_CIs():
    ...
    with model.fitter('ss') as fit:
        ...
        # slove the flux
        res = fit.solve_with_confidence_intervals(n_runs = 90, n_jobs = 3)   # no prepare
...
if __name__ == '__main__':
    ...
    toy_model_steady_state()
    toy_model_steady_state_with_CIs()

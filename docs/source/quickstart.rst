...
A model can be defined in either a tab-separated values (.tsv) or Excel spreadsheet (.xlsx) `file <https://github.com/Chaowu88/freeflux/blob/main/models/toy/reactions.tsv>`__ with the following required format:
